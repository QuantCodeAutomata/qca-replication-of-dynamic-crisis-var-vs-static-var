...
* **Returns** — daily log returns $\log\left(\frac{P_t}{P_{t-1}}\right)$.
...
* **Bridge volatility** — the paper states $\sigma = 0.11$ in §5.5 and
  table 7. Figure 4, however, shows fitted cumulative-QV slopes close to
  0.11 for three of the four portfolios (and approximately 0.07 for Finance),
  suggesting that the same numerical value may have been carried over as
  $\sigma$ through a minor notational or normalization slip. Under the
  isotropic model, the Cholesky manifold Cholₙ has dimension
  $n(n-1)/2$. The slope $\alpha$ is the aggregate QV rate across these
  tangent coordinates, so the corresponding per-coordinate diffusion
  parameter is $\sigma_{\mathrm{bridge}}=\sqrt{2\alpha/(n(n-1))}$.
  At $n=10$, the dimension of Cholₙ is $45$, so the slopes in figure 4
  imply values near 0.04–0.05. We therefore use this
  dimension-adjusted calibration, estimated separately for every scenario
  from the pre-as-of EWMA geodesic-QV slope. In our replication, it produces
  results substantially closer to the paper’s table 6 than treating 0.11
  directly as the diffusion parameter.
...
<p align="center">
  <a href="figures/exp1_loss_histograms.png">
    <img src="figures/exp1_loss_histograms.png" alt="Static and dynamic loss distributions across the 12 crisis scenarios" width="720">
  </a>
</p>

<p align="center">
  <a href="figures/exp1_uplift_bars.png">
    <img src="figures/exp1_uplift_bars.png" alt="Dynamic VaR uplift by portfolio and crisis" width="720">
  </a>
</p>
...
<p align="center">
  <a href="figures/exp2_diffusion_offdiag_hist.png">
    <img src="figures/exp2_diffusion_offdiag_hist.png" alt="Distribution of off-diagonal correlations after manifold diffusion" width="720">
  </a>
</p>

<p align="center">
  <a href="figures/exp2_bridge_paths.png">
    <img src="figures/exp2_bridge_paths.png" alt="Brownian-bridge correlation and geodesic-distance paths" width="720">
  </a>
</p>
...
<p align="center">
  <a href="figures/exp3_qv_linearity.png">
    <img src="figures/exp3_qv_linearity.png" alt="Cumulative quadratic variation and fitted linear trends" width="720">
  </a>
</p>
...
<p align="center">
  <a href="figures/exp4_distance_vs_uplift.png">
    <img src="figures/exp4_distance_vs_uplift.png" alt="Geodesic distance versus simulated VaR uplift" width="720">
  </a>
</p>
...
* The dynamic VaR function requires an explicitly calibrated `sigma_bridge`;
  it does not silently substitute the paper’s $\sigma = 0.11$.
